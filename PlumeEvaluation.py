...
def plot_metrics(df, sort_by='condition'):
    ...
    :param sort_by: to specify how the plume metrics be sorted.
    Options: "growth_index" uses plume index as label, "condition" uses different growth condition as label
