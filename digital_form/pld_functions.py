...
class PLD_Form(QWidget):
    ...
    The "plume" version also provide features to manage, pack, and upload recorded plumes along with recorded parameters. 
    Available versions: "parameter", "plume", while default is "parameter".
    '''
