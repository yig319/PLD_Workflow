...
from ..raw.widgets import AfmDataDropBlock


class AfmPfmVisualizerWindow(QWidget):
...
def main() -> int:
    ...
    window = AfmPfmVisualizerWindow()
    window.show()
    return app.exec_()


AfmVisualizerWindow = AfmPfmVisualizerWindow

__all__ = ["AfmPfmVisualizerWindow", "AfmVisualizerWindow", "main"]
